<template>
  <div class="home container">
    ...
    <Donations />
    <button @click="showModal" class="btn btn-lg btn-success my-4">Make A Difference!</button>
    <NewDonation :visible="this.modalVisible" />
  </div>
</template>
...
.home{
  ...
  height: 50em;
  box-shadow: #3d3d3d 5px 5px 15px;
}

body{
  background: no-repeat linear-gradient(to bottom right, #9A1750, #EE4C7C, #E3AFBC);
  background-size: 100%;
  height: 100vh;
}
