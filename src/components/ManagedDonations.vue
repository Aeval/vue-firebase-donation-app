    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            <tr v-for="donation in donations" :key="donation.id">
                ...
                <td v-if="donation.newsletter"><i class="fas fa-newspaper"></i></td>
                <td v-else></td>
                <!-- End newsletter block -->
                <td><i @click="showEditModal(donation)" class="fas fa-edit"></i></td>
                <td><i @click="deleteDonation" class="fas fa-trash"></i></td>
            </tr>
        </tbody>
    </table>
    <!-- Edit Modal Start -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body p-4">
              <form>
                ...
                <button @click.prevent="addDonation" type="submit" class="btn btn-lg btn-success my-2">Confirm</button>
              </form>
            </div>
          </div>
        </div>
